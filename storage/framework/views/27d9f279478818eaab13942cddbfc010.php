        ...
        <div class="flex flex-row items-center gap-x-3 text-sm py-1">
            <div class="w-full">
                <div class="flex gap-x-3">
                    <div class="block">
                        <div class="font-semibold"><?php echo e(__('Company')); ?>: </div>
                    </div>

                    <div class="flex-1">
                        <div><?php echo e(filament()->getTenant()->getAttributeValue('name')); ?></div>
                    </div>
                </div>

                <div class="flex gap-x-3">
                    <div class="block">
                        <div class="font-semibold"><?php echo e(__('User')); ?>: </div>
                    </div>

                    <div class="flex-1">
                        <div><?php echo e($user->user_id); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/Clients/ControlInternacionalInspector/resources/views/filament/main/widgets/company-widget.blade.php ENDPATH**/ ?>