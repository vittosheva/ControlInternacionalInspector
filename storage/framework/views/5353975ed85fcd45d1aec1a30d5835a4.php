...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => $getColor($value),'disabled' => $shouldOptionBeDisabled,'for' => $inputId,'icon' => $getIcon($value),'tag' => 'label']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/vittoriodormi/Desktop/VITTOSHEVA/GitHub/LARAVEL/Clients/ControlInternacionalInspector/vendor/filament/forms/resources/views/components/toggle-buttons/index.blade.php ENDPATH**/ ?>