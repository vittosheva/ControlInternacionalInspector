...
<?php unset($__defined_vars); ?>
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        <?php if(filament()->auth()->check()): ?>
            ...
            >
                <?php if(filament()->hasDatabaseNotifications() && filament()->auth()->user()->hasConfirmedTwoFactor() && filament()->auth()->user()->hasValidTwoFactorSession()): ?>
                    <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1304078306-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/vittoriodormi/Desktop/VITTOSHEVA/GitHub/LARAVEL/Clients/ControlInternacionalInspector/resources/views/vendor/filament-panels/components/layout/simple.blade.php ENDPATH**/ ?>