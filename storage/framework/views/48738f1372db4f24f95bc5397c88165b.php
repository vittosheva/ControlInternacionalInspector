            ...
            <?php if($isBulkToggleable && count($getOptions())): ?>
                ...
                >
                    <span
                        ...
                        wire:key="<?php echo e($this->getId()); ?>.<?php echo e($statePath); ?>.<?php echo e($field::class); ?>.actions.select_all"
                    >
                    ...
                    <span
                        x-show="areAllCheckboxesChecked"
                        x-on:click="toggleAllCheckboxes()"
                        wire:key="<?php echo e($this->getId()); ?>.<?php echo e($statePath); ?>.<?php echo e($field::class); ?>.actions.deselect_all"
                    >
...
<?php endif; ?>
<?php /**PATH /Users/vittoriodormi/Desktop/VITTOSHEVA/GitHub/LARAVEL/Clients/ControlInternacionalInspector/vendor/filament/forms/resources/views/components/checkbox-list.blade.php ENDPATH**/ ?>