...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          1 => 'insp.controlinternacional.com',
          2 => 
          array (
            'GET' => 0,
            'HEAD' => 1,
        ...
        array (
          ...
          1 => 'admin.controlinternacional.com',
          2 => 
          array (
            'GET' => 0,
            'HEAD' => 1,
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::DjKnV7v9wSlC7uUP',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::ecK3mDbrFin4SbGY',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|(?:(?:[^./]*+\\.)++)(?|/_debugbar/c(?|lockwork/([^/]++)(*:61)|ache/([^/]++)(?:/([^/]++))?(*:95))|/filament/(?|exports/([^/]++)/download(*:141)|imports/([^/]++)/failed\\-rows/download(*:187)))|(?i:insp\\.controlinternacional\\.com)\\.(?|/email\\-verification/verify/([^/]++)/([^/]++)(*:283)|/inspections/([^/]++)(?|(*:315)|/edit(*:328)))|(?i:admin\\.controlinternacional\\.com)\\.(?|/permissions/([^/]++)/edit(*:406)|/roles/([^/]++)/edit(*:434)|/users/([^/]++)/edit(*:462))|(?:(?:[^./]*+\\.)++)(?|/livewire/preview\\-file/([^/]++)(*:525))|(?i:insp\\.controlinternacional\\.com)\\.(?|/pdf/(?|generate/([^/]++)(?:/([^/]++))?(*:614)|view/([^/]++)(*:635))))/?$}sDu',
    ),
    3 => 
    array (
      61 => 
  ...
  array (
    ...
    array (
      ...
      'action' => 
      array (
        'domain' => 'https://insp.controlinternacional.com',
        'middleware' => 
        array (
          0 => 'panel:main',
    ...
    array (
      ...
      'action' => 
      array (
        'domain' => 'https://admin.controlinternacional.com',
        'middleware' => 
        array (
          0 => 'panel:superAdmin',
          1 => 'Illuminate\\Cookie\\Middleware\\EncryptCookies',
