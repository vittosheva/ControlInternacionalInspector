...
class SriValidarComprobanteWs
{
     ...
     * @throws SoapFault
     */
    public function __construct(public $wsdl, ?array $array = null)
    {
    ...
    public function validarComprobante(string $signedXml)
    {
        try {
            return $this->client->__soapCall('validarComprobante', [
                'validarComprobante' => [
                    'xml' => $signedXml,
                ],
            ]);
